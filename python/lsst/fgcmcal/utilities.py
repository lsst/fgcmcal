...
def makeConfigDict(config, log, camera, maxIter,
    ...
    configDict = {'outfileBase': outfileBase,
                  ...
                  'nStarPerGrayRun': config.nStarPerGrayRun,
                  'nObsPerRun': config.nObsPerRun,
                  'nObsPerGrayRun': config.nObsPerGrayRun,
                  ...
                  'superStarForceZeroMean': config.superStarForceZeroMean,
                  ...
                  'useRetrievedPwv': config.useRetrievedPwv,
                  'pwvRetrievalSmoothBlock': config.retrievedPwvSmoothingBlock,
                  'retrievedPwvBands': list(config.retrievedPwvBands),
